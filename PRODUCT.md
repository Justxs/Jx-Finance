...
Jx Finance is a self-hosted ledger for personal finances and small households. It records income, expenses, transfers, currency conversions, investments, assets and debts, and turns them into balances, budgets, goals, net worth and reports in one reporting currency. It never connects to a bank and never moves money.
...
- Reports cover custom date ranges. Exports are the filtered transactions as CSV and PDF, from Transactions and, for the report period, from Reports.

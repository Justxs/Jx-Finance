...
namespace JxFinance.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260926152141_AddBrokerConnectionFundingAccountForeignKey")]
    partial class AddBrokerConnectionFundingAccountForeignKey
    {
        /// <inheritdoc />
                    ...
                    b.ComplexCollection(typeof(List<Dictionary<string, object>>), "Changes", "JxFinance.Domain.Audit.AuditEvent.Changes#AuditChange", b1 =>
                        {
                            ...
                            b1.Property<string>("From")
                                .HasJsonPropertyName("from");

                            b1.Property<string>("To")
                                .HasJsonPropertyName("to");
            ...
            modelBuilder.Entity("JxFinance.Domain.NetWorth.Asset", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "CurrentValue", "JxFinance.Domain.NetWorth.Asset.CurrentValue#Money", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("JxFinance.Domain.NetWorth.Debt", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "OutstandingAmount", "JxFinance.Domain.NetWorth.Debt.OutstandingAmount#Money", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("JxFinance.Infrastructure.Auth.AppUser", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "DashboardLayout", "JxFinance.Infrastructure.Auth.AppUser.DashboardLayout#DashboardLayout", b1 =>
                        {
                            b1.PrimitiveCollection<string>("Hidden")
                                .IsRequired()
                                .HasJsonPropertyName("hidden");

                            b1.PrimitiveCollection<string>("Order")
                                .IsRequired()
                                .HasJsonPropertyName("order");

                            b1
                                .ToJson("DashboardLayout")
                                .HasColumnType("jsonb");
                        });

    ...
    : Endpoint<CreateInvestmentTransactionRequest, InvestmentTransactionResponse>
{
    public override void Configure()
    {
        ...
        Description(d => d.ClearDefaultProduces(200).Produces<InvestmentTransactionResponse>(201, "application/json"));
    }
    ...
    public override async Task HandleAsync(CreateInvestmentTransactionRequest req, CancellationToken ct)
    {
        ...
        await Send.ResultAsync(TypedResults.Created($"/api/investments/transactions/{created.Id}", created));
    }
}

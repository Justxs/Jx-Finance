...
```mermaid
flowchart TD
    Get["GET /api/recurring-bills/suggestions"] --> Read["expenses the caller can see:<br/>last 24 months, not split,<br/>newest 4000 rows, five columns"]

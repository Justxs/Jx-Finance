...
flowchart TD
    ...
    Tx --> Record["the transaction ids it is on:<br/>recorded as DeletionChanges"]
    Record --> Join["TransactionTags rows for it: deleted outright"]

...
erDiagram
    ...
    DELETION_ENTRY {
        uuid Id
        string Kind "transaction, transfer, conversion, budget, goal, asset, debt, recurringBill, investmentTransaction"

...
The CSV and PDF buttons on the page are transaction exports (`/api/transactions/export`), not exports of the report, so they are unchanged and carry no comparison. See [Exports](<19. Exports.md>).

 ...
 */
import type { IReadOnlyListOfInvestmentTransactionResponse } from "./iReadOnlyListOfInvestmentTransactionResponse";

export interface PagedResponseOfInvestmentTransactionResponse {
  items: IReadOnlyListOfInvestmentTransactionResponse;
  page: number;
  pageSize: number;
  total: number;
}

 ...
 */
import type { PositionMismatchResponse } from "./positionMismatchResponse";
import type { SkippedCorporateActionResponse } from "./skippedCorporateActionResponse";

export interface BrokerImportResponse {
  trades: number;
  cashEntries: number;
  conversions: number;
  transfers: number;

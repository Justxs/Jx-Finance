 ...
 */
import type { IReadOnlyListOfConversionResponse } from "./iReadOnlyListOfConversionResponse";

export interface PagedResponseOfConversionResponse {
  items: IReadOnlyListOfConversionResponse;
  page: number;
  pageSize: number;
  total: number;
}

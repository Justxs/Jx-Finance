 ...
 */
import type { AccountSortField } from "./accountSortField";
import type { AccountType } from "./accountType";
import type { SortDirection } from "./sortDirection";

export type GetAccountsEndpointParams = {
  /**
   * Case-insensitive match against the account name.
   * @nullable
   */
  search?: string | null;
  /**
   * Case-insensitive match against the IBAN.
   * @nullable
   */
  iban?: string | null;
  /**
   * Keep only accounts of this type.
   */
  type?: AccountType;
  /**
   * Field to sort by. Defaults to creation order.
   */
